...
void HID_CtrlSetupAck()
{
	uint32_t i;
	//int eUsbState;
	S_USBINFRA_CTRL_CALLBACK_ENTRY const *psEntry = 0;
	...
	{
		psEntry = psDevice->asCtrlCallbackEntry + i;
...
S_USBINFRA_CTRL_CALLBACK_ENTRY asCtrlCallbackEntry[] =
{
