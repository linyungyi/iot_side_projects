...
/*
	using SPI0(P1.4=SS0,P1.7=CLK,P1.6=MISO0,P1.5=MOSI0) as Master
*/
...
{
	/* Configure SPIx as a master, 32-bit transaction */
...
int32_t main()
{
    ...
    UNLOCKREG();
   	...
   	SystemCoreClock = 22000000;//__IRC22M
