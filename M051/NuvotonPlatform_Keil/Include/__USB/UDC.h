...
// CFG
#define	CFG0_SETTING	(CFGx_STALL_CTL | CFGx_EPT_IN  | 0) /* EP address 0, control IN  */
#define	CFG1_SETTING	(CFGx_STALL_CTL | CFGx_EPT_OUT | 0) /* EP address 0, control OUT */
#define	CFG2_SETTING	(CFGx_EPT_IN  | 2)                  /* EP address 2 */
#define	CFG3_SETTING	(CFGx_EPT_OUT | 3)                  /* EP address 3 */
