...
#define _PORT_DOUT(PortNum, PinNum)      (*((uint32_t *) ((PORT_BIT_DOUT+(0x20*PortNum)) + (0x4*PinNum))))    
...
/*---------------------------------------------------------------------------------------------------------*/
void DrvGPIO_Open(E_DRVGPIO_PORT port, E_DRVGPIO_PIN pin, E_DRVGPIO_IO mode);
