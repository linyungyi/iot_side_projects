========================================================================
    MFC 程式庫：MyHidLib 專案概觀
========================================================================


AppWizard 已經為您建立了這個 MyHidLib DLL。這個 DLL 不僅
示範了使用 MFC 的基本概念，也是您撰寫 DLL 的起點。

這個檔案包含一份摘要，簡要說明構成 MyHidLib DLL 的
所有檔案，它們個別的內容。
...
MyHidLib.h
    這是 DLL 的主要標頭檔。它宣告了 CMyHidLibApp 類別。

MyHidLib.cpp
    這是主要 DLL 原始程式檔。它含有 CMyHidLibApp 類別。
...
StdAfx.h, StdAfx.cpp
    這些檔案是用來建置名為 MyHidLib.pch 的先行編譯標頭 (PCH) 檔，
